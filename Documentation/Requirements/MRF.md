...
4. The columns that show the metrics express both the value of the metric as well as the percentage of change **compared to the _baseline_ model** (we're striving for percentage increase, but should report every case).
