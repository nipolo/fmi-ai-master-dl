...
class TestInit(unittest.TestCase):
    ...
    def test_when_called_then_builds_linear_model(self):
        ...
        # Act
        generator = gan.Generator(layer_neurons)
        actual_num_in = generator.layers[0].in_features
        actual_num_out = generator.layers[-2].out_features
        actual_last_layer = generator.layers[-1]
        actual_layers = generator.layers
        ...
        self.assertIsInstance(generator, expected_cls_disc)
...
class TestForward(unittest.TestCase):
    ...
    def test_when_called_then_returns_predictions(self):
        ...
        # Act
        generator = gan.Generator(layer_neurons)
        actual_shape_output = generator(random_noise).shape
